...
% generated data: performance curve for pixel and DoG populations (no nuisance)
...
lambda0 = 3; phi0 = 180; stim_DC = 0.5; c0 = 0.5;
...
load('script_2d_pixel_DoG_Gabor_v1_data.mat','Gabor_std')
...
load('script_2d_pixel_DoG_Gabor_v1_data.mat','DoG_meanvec2d','DoG_stdvec2d','pixel_meanvec2d','pixel_stdvec2d')
...
xlabel('threshold [mV]');
ylabel('performance');
title({sprintf('N = %d, K = %d, MK = %d, M1 = %d, M2 = %d',N,K,MK,M1,M2),sprintf('convcrit = %g, eta0 = %g, resolution = %g mV',conv_crit,eta0,thresholds(2)-thresholds(1)) })
