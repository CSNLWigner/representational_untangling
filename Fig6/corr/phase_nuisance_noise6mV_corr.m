...
save(sprintf('%s_data.mat',mfilename),'corr_values','corr_reference','reference_index','N','K','MK','J','M1','M2','maxiter','conv_crit','eta0','disk_radius','gcenter_seed','gphi_seed','stim_DC','V0','V1','noise','lambda0','sigma0','c0','thresholds','FC_LIN','PFC_LIN','RUNTIMES_LIN','ITERATIONS','GBANK');
...
for i1 = 1:N1
    ...
    legend_strings{end+1} = sprintf('corr = %.2g (%dmin)%s',corr_values(i1),ceil(sum(RUNTIMES_LIN(i1,:))/60),ref);
