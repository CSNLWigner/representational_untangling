...
save(sprintf('%s_data.mat',mfilename),'V1_values','N','K','MK','J','M1','M2','maxiter','conv_crit','eta0','disk_radius','gcenter_seed','gphi_seed','stim_DC','V0','noise','lambda0','sigma0','c0','thresholds','FC','PFC','RUNTIMES','ITERATIONS','GBANK');
...
for i1 = 1:N1
    ...
    legend_strings{end+1} = sprintf('V1 = %.2g (%dmin)',V1_values(i1),ceil(sum(RUNTIMES(i1,:))/60));
